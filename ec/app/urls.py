...
urlpatterns = [
    ...
    path('password_reset_confirm/<uidb64>/<token>/', auth_view.PasswordResetConfirmView.as_view(template_name='app/passwword_reset_confirm.html',
...
admin.site.site_header = "Attire"
admin.site.site_title = "Attire"
admin.site.site_index_title = "Welcome to Attire Boutique "